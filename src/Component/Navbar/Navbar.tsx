      ...
      <div className={styles.nav_container}>
        ...
        <div className={styles.box_2}>
          ...
          <div className={styles.profile_image_box}>
            <img className={styles.profile_image} src="https://c8.alamy.com/compde/2j3b2t7/3d-illustration-eines-lachelnden-geschaftsmannes-nahaufnahme-portrat-cute-cartoon-mann-avatar-charakter-gesicht-isoliert-auf-weissem-hintergrund-2j3b2t7.jpg" alt="" onClick={toggle} />
